...
class ProteinFeatures(nn.Module):
    ...
    def forward(self, X, mask, residue_idx, chain_labels):
        ...
        # print("residue_idx",residue_idx.shape,residue_idx[0][0])
...
class ProteinMPNNOracle(nn.Module):
    def __init__(self, node_features=128, edge_features=128,
        ...
        # a mean_polled layer followed by an mlp
        self.W_out_mlp = nn.ModuleList([
    ...
    def forward(self, X, S, mask, chain_M, residue_idx, chain_encoding_all):
        ...
        # MLP
        for layer in self.W_out_mlp:
            h_V_mean = layer(h_V_mean)
        return h_V_mean.squeeze(-1)
