...
This codebase is developed on top of [DRAKES (Wang et.al, 2024)](https://github.com/ChenyuWang-Monica/DRAKES/tree/master/drakes_dna).
...
```
python glide.py --name test
```
The fine-tuned model weights are provided in `BASE_PATH/mdlm/glide/finetuned.ckpt`

### Evaluation
See `eval.ipynb`

### Adaptations
Change the `base_path` in `dataloader_gosai.py`, `glide.py`, `oracle.py`, `train_oracle.py`, `eval.ipynb` to `BASE_PATH` for saving data and models.
...
* The pretrained model is provided by [Wang et al., 2024](https://github.com/ChenyuWang-Monica/DRAKES/)
